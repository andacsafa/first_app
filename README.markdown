...
temel kullanımları görmek için Model Rehberine bakabilirsiniz. -> http://guides.rubygems.org/patterns/#consistent-naming
...
Gemspec dosyası da Ruby dilinde yazılmaktadır. Bu sayede betiklerinizi yazıp dosya isimleri oluşturabilir, sürümü değiştirebilirsiniz. Gemspec dosyası birçok alanı içermektedir. Hepsini görebilmek için tam kaynağa bakabilirsiniz -> http://guides.rubygems.org/specification-reference/
